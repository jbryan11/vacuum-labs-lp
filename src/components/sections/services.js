...
const Services = () => {
  const data = useStaticQuery(graphql`
    query {
      webappImg: file(relativePath: { eq: "vacuum/today-apps-30.png" }) {
        childImageSharp {
      ...
      standaloneImg: file(relativePath: { eq: "vacuum/software-30.png" }) {
        childImageSharp {
      ...
      iotImg: file(relativePath: { eq: "vacuum/iot-sensor-50.png" }) {
        childImageSharp {
      ...
      cmsImg: file(relativePath: { eq: "vacuum/plesk-50.png" }) {
        childImageSharp {
          fluid(maxWidth: 100, quality: 100) {
            ...GatsbyImageSharpFluid_tracedSVG
          }
      ...
      ecommImg: file(relativePath: { eq: "vacuum/online-shop-64.png" }) {
        childImageSharp {
     ...
     entrImg: file(relativePath: { eq: "vacuum/enterprise-resource-planning-64.png" }) {
        childImageSharp {
          fluid(maxWidth: 98, quality: 100) {
            ...GatsbyImageSharpFluid_tracedSVG
          }
